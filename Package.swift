    ...
    targets: [
        ...
        .target(
            ...
            exclude: ["libheif/libheif/box_fuzzer.cc", "libheif/libheif/color_conversion_fuzzer.cc", "libheif/libheif/encoder_fuzzer.cc", "libheif/libheif/file_fuzzer.cc",
                      ...
                      "libheif/libheif/plugins/heif_decoder_aom.cc",
                      "libheif/libheif/plugins/heif_encoder_x265.h",
                      "libheif/libheif/plugins/heif_encoder_x265.cc",
                      "libheif/libheif/plugins/heif_decoder_dav1d.h",
                      "libheif/libheif/plugins/heif_decoder_dav1d.cc",
                      "libheif/libheif/plugins/heif_encoder_rav1e.h",
                      "libheif/libheif/plugins/heif_encoder_rav1e.cc",
                      "libheif/libheif/plugins/heif_encoder_svt.h",
                      "libheif/libheif/plugins/heif_encoder_svt.cc"],
