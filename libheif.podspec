...
HEIF is a new image file format employing HEVC (h.265) image coding for the best compression ratios currently possible.
  ...
  s.prepare_command = <<-CMD
                      ...
                      sed -i.bak 's/#define[[:space:]]LIBHEIF_NUMERIC_VERSION.*/#define LIBHEIF_NUMERIC_VERSION 0x01060200/g' './libheif/heif_version.h'
                      sed -i.bak 's/#define[[:space:]]LIBHEIF_VERSION.*/#define LIBHEIF_VERSION "1.6.2"/g' './libheif/heif_version.h'
